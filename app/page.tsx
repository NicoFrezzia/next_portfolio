    ...
    <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 text-gray-700 dark:text-gray-200">
      ...
      <div className="space-y-4">
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl text-gray-900 dark:text-white">
          Hi, I’m Nicholas Frezzia
        </h1>
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl">
          I build scalable, user-centered applications using technologies like React, Java, Python, and AWS. My focus is on performance, reliability, and crafting seamless digital experiences from front to back.
        </p>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600 dark:text-gray-300 max-w-2xl">
          I’m a full-stack developer who enjoys building fast, modern applications with React, Java, and AWS. Whether I’m designing smooth user interfaces or developing backend systems, I focus on performance, scalability, and clarity in every project.
        </p>
        <Link
          href="/about"
